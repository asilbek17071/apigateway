    ...
    "paths": {
        ...
        "/message/delete/{id}": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "PermissionSender",
                        "name": "persmission_sender",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "PermissionReceiver",
                        "name": "persmission_receiver",
                        "in": "query",
                        "required": true
                    }
                ],
        ...
        "/salary/admin/list": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Bo'tga adminni id si",
                        "name": "id",
                        "in": "query"
                    }
                ],
        ...
        "/salary/personal/list": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Bo'tga personlani id si",
                        "name": "id",
                        "in": "query"
                    }
                ],
        ...
        "/salary/teacher/list/": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Bo'tga teacher yoki assistantni id si",
                        "name": "id",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.TargetResp"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/target/create/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "targetCreateRequest",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.TargetsList"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/target/update/": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "targetUpdateRequest",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TargetUpdate"
                        }
                    }
                ],
                "responses": {
