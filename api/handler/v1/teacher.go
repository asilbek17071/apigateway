...
// @Router /teacher/password/update/{id} [put]
// @Summary TeacherPasswordUpdate
// @Description This API for updating teacher
// @Tags teacher
// @Accept  json
// @Produce  json
// @Param id path string true "ID"
// @Param Teacher request body models.PasswordUpdate true "teacherUpdateRequest"
// @Success 200 {object} models.FinResp
// @Failure 400 {object} models.StandardErrorModel
// @Failure 500 {object} models.StandardErrorModel
func (h *handlerV1) TeacherPasswordUpdate(c *gin.Context) {
	queryParams := c.Request.URL.Query()
	...
	response, err := h.serviceManager.TeacherService().TeacherPasswordUpdate(ctx, &body)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": err.Error(),
		})
		h.log.Error("failed to update password teacher", l.Error(err))
		return
	}
