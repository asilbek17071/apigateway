...
// PaymentStudent ...
// @Router /payment/studentlist/ [get]
// @Summary PaymentStudent
// @Description This API for getting list of payments
// @Tags payment
// @Accept  json
// @Produce  json
...
// @Failure 400 {object} models.StandardErrorModel
// @Failure 500 {object} models.StandardErrorModel
func (h *handlerV1) PaymentStudent(c *gin.Context) {
	queryParams := c.Request.URL.Query()
	...
	response, err := h.serviceManager.FinanceService().PaymentStudent(
		ctx, &pb.PySt{
			StudentId: params.StudentId,
			GroupId:   params.GroupId,
		})
