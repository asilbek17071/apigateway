...
// StudentPhoneDelete ...
// @Router /student/deletephone/{id} [delete]
// @Summary StudentPhoneDelete
...
// @Failure 400 {object} models.StandardErrorModel
// @Failure 500 {object} models.StandardErrorModel
func (h *handlerV1) StudentPhoneDelete(c *gin.Context) {
	queryParams := c.Request.URL.Query()
	...
	response, err := h.serviceManager.StudentService().StudentPhoneDelete(
		ctx, &pb.ByIdReq{
			Id: params.Id,
		})
	if err != nil {
