...
type Response struct {
	...
	Given                string   `protobuf:"bytes,5,opt,name=given,proto3" json:"given"`
	Debt                 string   `protobuf:"bytes,6,opt,name=debt,proto3" json:"debt"`
	Surcharge            string   `protobuf:"bytes,7,opt,name=surcharge,proto3" json:"surcharge"`
	PrepaidExpense       string   `protobuf:"bytes,8,opt,name=prepaid_expense,json=prepaidExpense,proto3" json:"prepaid_expense"`
...
func (m *Response) GetGiven() string {
	if m != nil {
		return m.Given
	}
	return ""
...
func (m *Response) GetDebt() string {
	if m != nil {
		return m.Debt
	}
	return ""
...
func (m *Response) GetSurcharge() string {
	if m != nil {
		return m.Surcharge
	}
	return ""
...
func (m *Response) GetPrepaidExpense() string {
	if m != nil {
...
var fileDescriptor_c04e2e1c1ba79a81 = []byte{
	...
	,
}
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrepaidExpense) > 0 {
		i -= len(m.PrepaidExpense)
		copy(dAtA[i:], m.PrepaidExpense)
		i = encodeVarintFinance(dAtA, i, uint64(len(m.PrepaidExpense)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Surcharge) > 0 {
		i -= len(m.Surcharge)
		copy(dAtA[i:], m.Surcharge)
		i = encodeVarintFinance(dAtA, i, uint64(len(m.Surcharge)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Debt) > 0 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.Surcharge = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.PrepaidExpense = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Comment", wireType)
